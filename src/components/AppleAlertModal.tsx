      ...
      <div className="w-full max-w-[360px] rounded-2xl bg-white text-black">
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-[15px] leading-tight text-black/80 mb-3">
            Your Apple ID was recently used at APPLE STORE for $849.99 Via Apple Pay Pre-Authorization!We have placed those request on hold to ensure safest and Security. Not you? Immediately call Apple Support <br />+1-888-858-7485 to Freeze it!.
          </p>
